...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_limited_to_user(self):
        user2 = get_user_model().objects.create_user("testuser2@gmail.com", "testpass")
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {"title": "Chiken Roll", "tags": [new_tag.id]}
    ...
    def test_full_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {"title": "Test Recipe", "time_minutes": 25, "price": 10.00}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="Vegatable Curry")
        recipe2 = sample_recipe(user=self.user, title="Caramel Custard")
        tag1 = sample_tag(user=self.user, name="Vegan")
        tag2 = sample_tag(user=self.user, name="Dessert")
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="Veg Sandwich")
        recipe2 = sample_recipe(user=self.user, title="Chineese Rice")
        ingredient1 = sample_ingredient(user=self.user, name="Bread")
        ingredient2 = sample_ingredient(user=self.user, name="Boiled Rice")
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title="Nachos")
        res = self.client.get(
